...
person.prototype = {
    draw: function () {
        ...
        this.cobj.drawImage(this[this.status][this.state], 0, 0, 68, 68, 0, 0, this.width, this.height);
        this.cobj.restore();
    },
    update: function () {
        if (this.y > this.endy) {
...
hinder.prototype={
    draw:function(){
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.hinderImg[this.state],0,0,565,399,0,0,this.width,this.height);
        this.cobj.restore();
    }
}
